				...
				while(!END_GAME){
					switch(ROBOT_STATE){
						...
						case HIT_BALL:
							...
							motionProxy.moveTo(0.4,0,0,MovConfig);
							motionProxy.moveTo(0.4,0,0,MovConfig);
...
void Kick_off()
{
		...
		motionProxy.moveTo(0.5, 0.0, 0.0, MovConfig);
		motionProxy.moveTo(0.5, 0.0, 0.0, MovConfig);
			 ...
			 switch(MOVE_STATE){
				  ...
				  case MOVE_TO_RIGHT:
					   //move to the right
						...
						motionProxy.moveTo(0.0, 0, -0.87f,MovConfig);
						SEARCH_STATE=1;
						break;
				  ...
				  case MOVE_TO_LEFT:
					  //move to the left
						...
						motionProxy.moveTo(0.0, 0.0, 1.4f,MovConfig);
						SEARCH_STATE=1;
						break;
